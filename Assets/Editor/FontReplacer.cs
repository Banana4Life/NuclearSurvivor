...
// Code based on:
// https://answers.unity.com/questions/1196846/how-do-i-change-font-of-all-texts-in-all-scenes.html
// Thanks to ThomLaurent
public class FontReplacer : EditorWindow
{
    ...
    private static void ReplaceFonts(Font src, Font dest, bool includePrefabs)
    {
        ...
        if (includePrefabs)
        {
            ...
            {
                var replacedFonts = ReplaceFonts(src, dest, prefab.GetComponentsInChildren<Text>(true));
                if (replacedFonts > 0)
                {
                    EditorUtility.SetDirty(prefab);
                }

                prefabMatches += replacedFonts;
            }
